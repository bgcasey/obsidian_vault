...
| ---------------------- | ---------------------------------------------------------- |
| Advanced Tables        | Improved table manipulation                                |
| Dataview               | Enables querying using JAvaScript API.                     |
| Minimal Theme Settings | Adds customization options for the Minimal Obsidian theme. |
| Numerals               | Turns code blocks into calculators.                        |
| Pandoc Reference List  | Formats references using BibTeX citation keys.             |
| Tasks                  | Tracks tasks accoss the vault.                             |
